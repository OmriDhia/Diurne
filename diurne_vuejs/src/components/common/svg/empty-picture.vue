<template>
    <svg :fill="$store.state.dark_mode === 'dark' ? '#ffffff' : '#000000'" width="58px" version="1.1"
        xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 58 58"
        xml:space="preserve">
        <g>
            <path
