                ...
                <template #panel-body>
                    ...
                    <div class="row p-3 align-items-center">
                        <div class="col-md-3 col-sm-6">
                            <d-input-secondary label="Date" type="date" v-model="paymentData.date"
...
<script setup>
    ...
    import {
        ...
        updateAllocationForNewItem
    } from '@/composables/useTreasuryAllocations';
    ...
    const handleQuoteSelection = async (quoteFullObject) => {
        ...
        try {
            ...
            quoteWithDetails.quoteData.quoteDetails.forEach(quoteDetail => {
                const allocation = createQuoteAllocation(quoteFullObject, quoteDetail, {
                    Helper,
                    DEFAULT_RN_PREFIX,
    ...
    const handleOrderSelection = async (invoiceFullObject) => {
        ...
        try {
            ...
            invoiceWithDetails.customerInvoiceDetails.forEach(invoiceDetail => {
                const allocation = createInvoiceAllocation(invoiceFullObject, invoiceDetail, {
                    Helper,
                    DEFAULT_RN_PREFIX,
                    DEFAULT_DISTRIBUTION
                });
