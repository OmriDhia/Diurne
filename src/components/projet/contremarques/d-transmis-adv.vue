    ...
    <div class="col-12">
        <div class="row">
            <div class="col-lg-8 col-md-12">
                <div class="row justify-content-between align-items-center mt-3">
                    ...
                    <div class="col-lg-5 col-md-12 d-flex">
                        <div class="checkbox-default custom-control custom-checkbox">
                            <input :disabled="disabled" type="checkbox" class="custom-control-input" id="hasConstraints"
                                   @change="createUpdateCustomerInstruction" v-model="data.hasConstraints" />
                            <label class="custom-control-label" for="hasConstraints"></label>
                        </div>
                        <d-btn-outlined :disabled="disabled" data-bs-toggle="modal"
                                        data-bs-target="#modalManageConstraint" label="Contraintes et remarque"
                                        icon="arrow-right" buttonClass="ps-1 font-size-0-6"></d-btn-outlined>
                    </div>
                ...
                <div class="row justify-content-between align-items-center mt-3">
                    <div class="col-lg-7 col-md-12">
                        <d-input :disabled="disabled" label="Transmi. ADV" @change="createUpdateCustomerInstruction"
                                 v-model="data.transmi_adv"></d-input>
                    </div>
                    <div class="col-lg-5 col-md-12 d-flex">
                        <div class="checkbox-default custom-control custom-checkbox">
                            <input :disabled="disabled" type="checkbox" class="custom-control-input"
                                   id="hasValidateSample" @change="createUpdateCustomerInstruction"
                                   v-model="data.hasValidateSample" />
                            <label class="custom-control-label" for="hasValidateSample"></label>
                        </div>
                        <d-btn-outlined :disabled="disabled" data-bs-toggle="modal"
                                        data-bs-target="#modalManageValidatedSimple" label="Ech. Validée de ref"
                                        icon="arrow-right" buttonClass="ps-1 font-size-0-6"></d-btn-outlined>
                ...
                <div class="row justify-content-between align-items-center mt-3">
                    <div class="col-lg-7 col-md-12">
                        <d-input type="date" label="Validation client" @change="createUpdateCustomerInstruction"
                                 v-model="data.customerValidationDate" :error="errorADV.dateCustomer"></d-input>
                    </div>
                    <div class="col-lg-5 col-md-12 d-flex">
                        <div class="checkbox-default custom-control custom-checkbox">
                            <input :disabled="disabled" type="checkbox" class="custom-control-input"
                                   id="hasFinitionInstruction" @change="createUpdateCustomerInstruction"
                                   v-model="data.hasFinitionInstruction" />
                            <label :disabled="disabled" class="custom-control-label"
                                   for="hasFinitionInstruction"></label>
                        </div>
                        <d-btn-outlined :disabled="disabled" data-bs-toggle="modal"
                                        data-bs-target="#modalManageFinishing" label="Finition" icon="arrow-right"
                                        buttonClass="ps-1 font-size-0-8"></d-btn-outlined>
                    </div>
        ...
        <div class="row justify-content-between align-items-start mt-3">
            <div class="col-auto">
                <d-btn-outlined label="Editer la demande de l'image projet" icon="arrow-right"
                                buttonClass="ps-1 font-size-0-8"></d-btn-outlined>
            </div>
            <div class="col-lg-4 col-md-12">
                <div class="row justify-content-between align-items-start mt-1 pe-2" v-if="canShowTransmisAdv">
                    <button class="btn btn-custom w-100 text-uppercase font-size-0-7" @click="transmisAdv"
                            :disabled="disabled">Transmettre l'image à l'ADV
                    </button>
                </div>
        ...
        <d-modal-create-variation :id_di="props.id_di"
                                  :carpetDesignOrderId="props.carpetDesignOrderId"></d-modal-create-variation>
    </div>
</template>
