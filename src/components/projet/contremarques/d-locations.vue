<template>
    <div class="row align-items-center">
        <d-modal-manage-locations ref="manageLocations" :locationData="selectedLocation"
                                  ...
                                  @onClose="handleClose" :saveAndStay="false"
                                  @addLocation="addNewLocation"></d-modal-manage-locations>
                ...
                <div class="col-md-12 col-xl-6">
                    <div class="row mt-2 mb-2 align-items-center block-custom-border ms-1">
                        ...
                        <div class="col-md-8 ps-1 ">
                            <ul class="list-group">
                                ...
                                <li class="pt-1 d-none">
                                    <d-btn-outlined label="Commande" icon="arrow-right"
                    ...
                    <div class="row pe-0 ps-3 justify-content-between">
                        <div class="col-auto p-0">
                            <button class="btn btn-custom pe-2 ps-2 h6" @click="goToImages(location.location_id)">Voir
                                Images
                            </button>
                        </div>
                        <div class="col-auto p-0">
                            <button class="btn btn-custom pe-2 ps-2 h6" @click="goToQuotes(location.location_id)"> Voir
                                Devis
                            </button>
                        </div>
                    </div>
...
<script setup>
    ...
    const goToImages = (location_id) => {
        console.log(props.contremarqueId, location_id);
        router.push({ name: 'di_list', query: { contremarqueId: props.contremarqueId, locationId: location_id } });
    };
