    ...
    <div class="row align-items-start p-2 bg-white" id="fullscreen">
        <div class="col-12 mb-2 mt-3 p-0" v-if="canManageComposition && !props.disabled">
            ...
            <d-composition-thread-new v-else :carpetSpecificationId="props.carpetSpecificationId"
                @newCarpetComposition="newCarpetComposition" @addThreads="addThreads"></d-composition-thread-new>
        </div>
                ...
                <tbody>
                    <tr v-for="(row, rowIndex) in rows" :key="rowIndex">
                        ...
                        <template v-for="(detail, detailIndex) in row.layer_details" :key="detailIndex">
                            <td><d-colors-dropdown :disabled="props.disabled" :hideLabel="true"
                                    v-model="detail.color_id"></d-colors-dropdown></td>
                            <td><d-materials-dropdown :disabled="props.disabled" :hideLabel="true"
                                    v-model="detail.material_id"> </d-materials-dropdown> </td>
