                            ...
                            <div class="card mb-1">
                                <header class="card-header" role="tab">
                                    <section class="mb-0 mt-0">
                                        <div class="collapsed d-flex justify-content-between align-items-center"
                                ...
                                <div :id="'event'+index" class="collapse" :aria-labelledby="'event'+index"
                                     data-bs-parent="#toggleAccordionEvent">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="row">
                                                    <d-input v-model="item.event" :disabled="true"></d-input>
                                                </div>
                                                <div class="row">
                                                    <d-input v-model="item.dateEvent" :disabled="true"></d-input>
                                                </div>
                                                <div class="row">
                                                    <d-input v-model="item.datePR" :disabled="true"></d-input>
                                                </div>
                                                <div class="row">
                                                    <d-input v-model="item.tissage" :disabled="true"
                                                             v-if="item.event === 'Tissage'"></d-input>
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <div class="row">
            ...
            if (provisionalCalendar.length > 0) {
                ...
                setTimeout(() => {
                    router.push({
                        ...
                        params: { workshopOrderId: props.workshopOrderId }
                    });
                }, 1000);
            }
        } else {
    ...
    const goToProvisionalCalendar = async () => {
        if (props.workshopOrderId) {
            ...
            if (provisionalCalendar.length > 0) {
                router.push({
                    name: 'provisionalCalendarView',
                    params: { workshopOrderId: props.workshopOrderId, id: provisionalCalendar[0].id }
                });
            } else {
