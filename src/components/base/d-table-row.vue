    ...
    <tr>
        ...
        <td class="align-reglement">
            <template v-if="isEditing">
                ...
                <button v-if="showViewButton" type="button" class="btn btn-dark mb-1 me-1 rounded-circle"
                        @click="startView(row)">
            ...
            <template v-else>
                ...
                <button v-if="showRattacherButton" type="button" class="btn btn-dark mb-1 me-1"
                        @click="startRattacher(row)">
                    Attribuer
                </button>
            </template>
            ...
            <div v-if="showViewButton" class="t-dot reglement"
                 :class="hasOrderPaymentDetails ? 'bg-success' : 'bg-danger'"></div>
        </td>
    </tr>
</template>
