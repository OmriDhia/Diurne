        ...
        <div class="row align-items-center pe-2 ps-2">
            ...
            <div class="col-md-6 col-sm-12 col-lg-3">
                <div class="row align-items-center">
                    <div class="col-3 text-black">{{ $t('Adresse eronée') }}:</div>
            ...
            <div class="col-md-3 col-sm-12">
                <div class="row align-items-center">
                    <div class="col-3 text-black">{{ $t('Adresse complète') }}:</div>
                    <div class="col-auto pe-1 ps-2">
                        <div class="custom-control custom-radio">
                ...
                <div class="row justify-content-end">
                    <div class="col-auto">
                        <div class="d-flex align-items-center mb-3">
                            <label class="me-2">Format d'export :</label>
                            <div class="form-check me-3">
                                <input class="form-check-input" type="radio" id="csv" value="csv" v-model="exportFormat" />
                                <label class="form-check-label" for="csv">CSV</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" id="xlsx" value="xlsx" v-model="exportFormat" />
                                <label class="form-check-label" for="xlsx">XLSX</label>
                            </div>
                        </div>

                        <button class="btn btn-outline-custom" @click="exportCustomers">
        ...
        <div class="row mt-2 mb-4">
            <div class="vue3-datatable w-100">
                ...
                <vue3-datatable
                    ...
                    noDataContent="Aucun contact trouvé."
...
<script setup>
    ...
    const exportFormat = ref('csv'); // Par défaut, CSV
    const getFilterParamsExport = () => {
        let param = '';
    ...
    const exportCustomers = async () => {
        try {
            ...
            url_customers += getFilterParamsExport();
            console.log("url_customers : " , url_customers);
            const response = await axiosInstance.get(url_customers, {
                responseType: 'blob', // Important pour les fichiers
            });

            // Création du Blob pour le téléchargement
            const blob = new Blob([response.data], { type: exportFormat.value === 'csv' ? 'text/csv' : 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet' });
            const url = window.URL.createObjectURL(blob);
            const a = document.createElement('a');
            a.href = url;
            a.download = `customers.${exportFormat.value}`;
