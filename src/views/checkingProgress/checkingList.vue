            ...
            <d-panel>
                ...
                <template v-slot:panel-body>
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-9">
                            <div class="row">
                                <div class="col-md-4">
                                    <fieldset>
                                        <d-panel-title class-name="ps-2" title="Validation graphique" link=""></d-panel-title>
                                        <d-radio-validation 
                                ...
                                <div class="col-md-4">
                                    <fieldset>
                                        <d-panel-title class-name="ps-2" title="Respect des instructions" link=""></d-panel-title>
                                        <d-radio-validation 
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <fieldset>
                                        <d-panel-title class-name="ps-2" title="Corps/Ondu/Coins" link=""></d-panel-title>
                                        <d-radio-validation 
                                ...
                                <div class="col-md-4">
                                    <fieldset>
                                        <d-panel-title class-name="ps-2" title="Auteur du velour" link=""></d-panel-title>
                                        <d-radio-validation 
                    ...
                    <div class="row mt-4">
                        <div class="col-md-3">
                            <fieldset>
                                <d-panel-title class-name="ps-2" title="Respect plan" link=""></d-panel-title>
                                <d-radio-validation 
                        ...
                        <div class="col-md-3">
                            <fieldset>
                                <d-panel-title class-name="ps-2" title="Respect hauteur de port" link=""></d-panel-title>
                                <d-radio-validation 
                        ...
                        <div class="col-md-3">
                            <fieldset>
                                <d-panel-title class-name="ps-2" title="Respect fosse" link=""></d-panel-title>
                                <d-radio-validation 
                        ...
                        <div class="col-md-3">
                            <fieldset>
                                <d-panel-title class-name="ps-2" title="Respect autre tapis" link=""></d-panel-title>
                                <d-radio-validation 
                        ...
                        <div class="col-md-3">
                            <fieldset>
                                <d-panel-title class-name="ps-2" title="Respect longeur Max/Min" link=""></d-panel-title>
                                <d-radio-validation 
                        ...
                        <div class="col-md-3">
                            <fieldset>
                                <d-panel-title class-name="ps-2" title="Respect largeur Max/Min" link=""></d-panel-title>
                                <d-radio-validation 
                        ...
                        <div class="col-md-3">
                            <fieldset>
                                <d-panel-title class-name="ps-2" title="Distance mur/haut" link=""></d-panel-title>
                                <d-radio-validation 
                        ...
                        <div class="col-md-3">
                            <fieldset>
                                <d-panel-title class-name="ps-2" title="Distance mur/bas" link=""></d-panel-title>
                                <d-radio-validation 
                        ...
                        <div class="col-md-3">
                            <fieldset>
                                <d-panel-title class-name="ps-2" title="Distance mur/droite" link=""></d-panel-title>
                                <d-radio-validation 
                        ...
                        <div class="col-md-3">
                            <fieldset>
                                <d-panel-title class-name="ps-2" title="Distance mur/gauche" link=""></d-panel-title>
                                <d-radio-validation 
                        ...
                        <div class="col-md-3">
                            <fieldset>
                                <d-panel-title class-name="ps-2" title="Respect couleur" link=""></d-panel-title>
                                <d-radio-validation 
                        ...
                        <div class="col-md-3">
                            <fieldset>
                                <d-panel-title class-name="ps-2" title="Respect matière" link=""></d-panel-title>
                                <d-radio-validation 
                        ...
                        <div class="col-md-3">
                            <fieldset>
                                <d-panel-title class-name="ps-2" title="Respect velour" link=""></d-panel-title>
                                <d-radio-validation 
                        ...
                        <div class="col-md-3">
                            <fieldset>
                                <d-panel-title class-name="ps-2" title="Respect remarque" link=""></d-panel-title>
                                <d-radio-validation 
...
<script setup>
    ...
    const createValidationObject = (relevant = null, validation = null, seen = null, comment = '') => ({
    ...
    const validateForm = () => {
        ...
        const fields = Object.values(form.value).filter(field => 
            typeof field === 'object' && field !== null && field.relevant !== undefined
        );
        
        for (const field of fields) {
            if (field.relevant === true && field.validation === false && field.seen === true && !field.comment) {
                return false;
            }
        }
    ...
    const saveCheckingList = async () => {
        ...
        try {
            console.log('=== SAVING CHECKING LIST ===');
            console.log('Checking List ID:', checkingListId);
            console.log('Shape Validation ID:', form.value.shapeValidationId);
            console.log('Quality Check ID:', form.value.qualityCheckId);
            console.log('Quality Respect ID:', form.value.qualityRespectId);
            ...
            savePromises.push(
                checkingListService.updateCheckingList(checkingListId, checkingListPayload)
            ...
            console.log('Shape Validation Payload:', shapeValidationPayload);
            savePromises.push(
                checkingListService.updateShapeValidation(form.value.shapeValidationId, shapeValidationPayload)
            ...
            savePromises.push(
                checkingListService.updateQualityCheck(form.value.qualityCheckId, qualityCheckPayload)
            ...
            console.log('Quality Respect Payload:', qualityRespectPayload);
            savePromises.push(
                checkingListService.updateQualityRespect(form.value.qualityRespectId, qualityRespectPayload)
