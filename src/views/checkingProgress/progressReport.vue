        ...
        <template #body>
            <d-panel>
                ...
                <template #panel-body>
                    <div class="row">
                        <div class="col-md-4">
                            <d-users-dropdown v-model="form.authorId" :required="true" />
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-4">
                            <d-base-dropdown name="Status" v-model="form.statusId" :datas="statuses" label="name" trackBy="id" />
                        </div>
                    </div>
                    <div class="row mt-3">
                        <div class="col-md-6">
                            <d-input type="number" label="Provisional calendar" v-model="form.provisionalCalendarId" />
                        </div>
                        <div class="col-md-6">
