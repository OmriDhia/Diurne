<template>
    <d-base-page>
        <template v-slot:title>
            <d-page-title title="Tapis Commande"></d-page-title>
        </template>
            ...
            <d-panel>
                <template v-slot:panel-body>
                    <div class="row mt-3 mb-3 pe-0">
                        <div class="col-8">
                            <div class="row">
                                <div class="col-lg-6  col-sm-12 pe-sm-0">
                                    <div class="col-12">
                                        <d-input label="Numéro de devis" v-model="quoteNumber"
                                                 :disabled="true"></d-input>
                                    </div>
                                    <div class="col-12">
                                        <d-input type="date" label="Date de création" v-model="createdDate"
                                    ...
                                    <div class="row">
                                        <d-qualities-dropdown :required="true"
                                                              v-model="data.carpetSpecification.qualityId"
                                ...
                                <div class="col-lg-6  col-sm-12 pe-sm-0">
                                    <d-imageDevisAttribution v-if="quoteDetailId"
                                                             ...
                                                             :image="quoteDetail.vignettePath"
                                    ...
                                    <d-panel-title title="Augmentation de tarif" className="ps-2"></d-panel-title>
                                    <div class="row ps-2 pt-2">
                                        <div class="custom-control custom-radio">
                                            <input type="checkbox" class="custom-control-input" id="useSpecialShape"
                                                   name="useSpecialShape"
                                                   v-model="data.carpetSpecification.hasSpecialShape" />
                                            <label class="custom-control-label text-black" for="useSpecialShape"> Forme
                                                spéciale
                                            </label>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <d-special-shapes
                                            v-model="data.carpetSpecification.specialShapeId"></d-special-shapes>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-12 pe-sm-0">
                            ...
                            <div class="row pe-2 ps-0 align-items-center">
                                <d-input label="Date de l'acompte"
                            ...
                            <div class="row pe-2 ps-0 align-items-center">
                                <div class="row align-items-center pt-2">
                                    <div class="col-4"><label class="form-label" for="shippingDelay">Délais livraison
                                        (semaine):</label></div>
                                    <div class="col-8"><input type="number" id="shippingDelay"
...
<script setup>
    ...
    import DCarpetOrderDetails from '@/components/projet/devis/d-carpet-order-details.vue';
    ...
    onMounted(async () => {
        ...
        if (quoteDetailId) {
            await Promise.all([
                ...
                getCarpetOrderDetail(quoteDetailId)
            ]);
        }
    });
