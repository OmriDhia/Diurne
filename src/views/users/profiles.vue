<template>
    <div class="layout-px-spacing mt-5">
        ...
        <div class="row layout-top-spacing">
            <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing" v-if="$hasPermission('create profile')">
                <div class="panel br-6 p-2">
                    <d-panel-title title="Nouveau Profile"></d-panel-title>
            ...
            <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
                <div class="panel br-6 p-2">
                    <d-panel-title title="Liste des Profiles"></d-panel-title>
                            ...
                            :page="params.current_page" :pageSize="params.pagesize"
                                ...
                                <template #name="data">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <router-link :to="'/users/profile/' + data.value.profile_id" v-if="$hasPermission('update profile')">
                                            <vue-feather type="edit-3" stroke-width="1"
