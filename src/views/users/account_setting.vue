                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                        <form id="general-info" class="section general-info">
                            <div class="info">
                                <d-panel-title
                                    :title="(id) ? 'Mise à jour utilisateur' : 'Nouveau utilisateur'"
                                    link="/users"></d-panel-title>
                                <div class="row">
                                    <div class="col-7">
                                        <div class="row m-2 mb-4">
                                            <div class="col-6">
                                                <div class="row align-items-center">
                                                    <d-input label="Nom" v-model="userObj.lastname" :required="true"
                                                             :error="error.lastname"></d-input>
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <div class="row align-items-center">
                                                    <d-input label="E-mail" v-model="userObj.email" :required="true"
                                                             :error="error.email"></d-input>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row m-2 mt-4">
                                            <div class="col-6">
                                                <d-input label="Prénom" v-model="userObj.firstname" :required="true"
                                                         :error="error.firstname"></d-input>
                                            </div>
                                            <div class="col-6">
                                                <d-profile v-model="userObj.profile"
                                                           :error="error.profileId"></d-profile>
                                            </div>
                                        </div>
                                        <div class="row m-2 mt-4">
                                            <div class="col-12">
...
<script setup>
    ...
    const getcurrentUser = async () => {
        try {
            ...
            userObj.isActive = res.isActive === true;
