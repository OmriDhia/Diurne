    ...
    const getOrderCarpet = async (id) => {
        try {
            if (id) {
                ...
                transDate.value = currentCarpetObject.value.transmition_date ? Helper.FormatDateTime(currentCarpetObject.value.transmition_date.date) : '';
