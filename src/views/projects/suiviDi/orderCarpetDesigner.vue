                ...
                <div class="row m-2">
                   <div class="col-md-12 col-xl-9 pe-4">
                       <div class="container p-0">
                           ...
                           <div class="row ps-2 mt-4 mb-2 justify-content-between"  v-if="carpetDesignOrderId">
                               <d-transmis-adv :customerInstruction="currentCarpetObject?.customerInstruction" :id_di="id_di" :carpetDesignOrderId="carpetDesignOrderId" @transmisAdv="updateCarpetDesignStatus($event)"></d-transmis-adv>
                           </div>
                       </div>
                   </div>
