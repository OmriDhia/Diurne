              ...
              <template v-slot:panel-header>
                  <div class="row p-2 align-items-center">
                      <div class="col-md-4 col-sm-12">
                          <d-input label="Numéro de devis" :required="true" v-model="data.quoteNumber" :error="error.quoteNumber"></d-input>
                      </div>
                      <div class="col-md-4 col-sm-12">
                          <d-input type="date" label="Date de création" :required="true" v-model="data.createdDate" :error="error.createdDate"></d-input>
                      </div>
                      <div class="col-md-4 col-sm-12">
                          <d-contremarque-dropdown v-model="data.contremarque" :error="error.contremarque"></d-contremarque-dropdown>
                      </div>
                  </div>
              </template>
          </d-panel>
        ...
        <template v-slot:body>
            <div class="row mt-3 mb-3 pe-0">
                <div class="col-md-6 col-sm-12 pe-sm-0">
                    <d-panel>
                        <template v-slot:panel-header>
                            <d-panel-title title="Client de la contremarque"></d-panel-title>
                        </template>
