                ...
                <template v-slot:panel-body>
                    <div class="row mt-3 mb-3 pe-0">
                        <div class="col-lg-4 col-md-6 col-sm-12 pe-sm-0">
                            ...
                            <div class="row">
                                <d-model-dropdown :required="true" :hideBtn="true" v-model="data.carpetSpecification.modelId" :error="validationSubmitErrors.modelId"></d-model-dropdown>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-12 pe-sm-0">
                            <d-panel-title title="Tapis de projet" className="ps-2"></d-panel-title>
                            <d-imageDevisAttribution
                                v-if="quoteDetailId"
                    ...
                    <div class="row mt-3 mb-3 pe-0">
                        <div class="col-lg-4 col-md-6 col-sm-12 pe-sm-0">
                            ...
                            <div class="row">
                                <d-tarifs :required="true" v-model="data.quoteDetail.TarifId" :error="validationSubmitErrors.tarifId" @confirm-change="openModal"></d-tarifs>
                            </div>
                            ...
                            <div class="row">
                                <d-qualities-dropdown :required="true" v-model="data.carpetSpecification.qualityId" :error="validationSubmitErrors.qualityId"></d-qualities-dropdown>
                            </div>
                            <div class="row">
