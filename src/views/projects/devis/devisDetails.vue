                ...
                <template v-slot:panel-body>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 pe-sm-0">
                            ...
                            <div class="row">
                                <d-collections-dropdown :required="true" :hideBtn="true"
                                    ...
                                    :error="error.collection"></d-collections-dropdown>
                            </div>
                            <div class="row">
                                <d-model-dropdown :required="true" :hideBtn="true"
                                    v-model="data.carpetSpecification.modelId"
                                    :error="error.modelId"></d-model-dropdown>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-12 pe-sm-0">
                            <d-panel-title title="Tapis de projet" className="ps-2"></d-panel-title>
                            <d-imageDevisAttribution :quoteDetailId="quoteDetailId" :contremarqueId="contremarqueId" />
                    ...
                    <div class="row mt-3 mb-3 pe-0">
                        <div class="col-lg-4 col-md-6 col-sm-12 pe-sm-0">
                            ...
                            <div class="row">
                                <d-tarifs :required="true" v-model="data.quoteDetail.TarifId" :error="error.tarifId"
                                    @confirm-change="openModal"></d-tarifs>
                            </div>
                            ...
                            <div class="row">
                                <d-qualities-dropdown :required="true" v-model="data.carpetSpecification.qualityId"
                                    :error="error.qualityId"></d-qualities-dropdown>
                            </div>
                            <div class="row">
