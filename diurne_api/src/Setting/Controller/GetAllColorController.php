...
use App\Setting\Bus\Query\Color\GetAllColorQuery;
...
#[Route('/api/color', name: 'get_all_colors', methods: ['GET'])] 
class GetAllColorController extends CommandQueryController
{
    #[OA\Parameter(
        name: "page",
        in: "query",
    ...
    #[OA\Response(
        response: 200,
        description: 'Fetch all available colors with pagination',
        content: new OA\JsonContent(
            ...
            properties: [
                new OA\Property(
                    property: 'data',
                    type: 'array',
                    items: new OA\Items(ref: new Model(type: Color::class))
                ),
                new OA\Property(
                    property: 'meta',
                    type: 'object',
