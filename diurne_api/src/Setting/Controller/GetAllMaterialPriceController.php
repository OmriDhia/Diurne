...
use App\Setting\Bus\Query\MaterialPrice\GetAllMaterialPriceQuery;
...
#[Route('/api/materialPrice', name: 'get_all_material_prices', methods: ['GET'])]
class GetAllMaterialPriceController extends CommandQueryController
{
    #[OA\Parameter(
        name: "page",
        in: "query",
    ...
    #[OA\Response(
        response: 200,
        description: 'Fetch all available material prices with pagination',
        content: new OA\JsonContent(
            ...
            properties: [
                new OA\Property(
                    property: 'data',
                    type: 'array',
                    items: new OA\Items(ref: new Model(type: MaterialPrice::class))
                ),
                new OA\Property(
                    property: 'meta',
                    type: 'object',
    ...
    public function __invoke(Request $request): JsonResponse
    {
        ...
        $query = new GetAllMaterialPriceQuery(
            $page > 0 ? $page : null,
        ...
        return SuccessResponse::create(
            'get_all_material_prices',
            $response->toArray(),
            'Material prices fetched successfully'
        );
    }
}
