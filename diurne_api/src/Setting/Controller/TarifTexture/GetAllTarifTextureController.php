...
use App\Setting\Bus\Query\TarifTexture\GetAllTarifTextureQuery;
...
#[Route('/api/tarifTextures', name: 'get_all_tarif_textures', methods: ['GET'])]
class GetAllTarifTextureController extends CommandQueryController
{
    #[OA\Parameter(
        name: "page",
        in: "query",
    ...
    #[OA\Response(
        response: 200,
        description: 'Fetch all available tarif textures with pagination',
        content: new OA\JsonContent(
            ...
            properties: [
                new OA\Property(
                    property: 'data',
                    type: 'array',
                    items: new OA\Items(ref: new Model(type: TarifTexture::class))
                ),
                new OA\Property(
                    property: 'meta',
                    type: 'object',
    ...
    public function __invoke(Request $request): JsonResponse
    {
        ...
        $query = new GetAllTarifTextureQuery(
            $page > 0 ? $page : null,
        ...
        return SuccessResponse::create(
            'get_all_tarif_textures',
            $response->toArray(),
            'Tarif textures fetched successfully'
        );
    }
}
