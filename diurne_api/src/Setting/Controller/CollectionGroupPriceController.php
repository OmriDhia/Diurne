...
use App\Setting\Bus\Query\CollectionGroupPrice\CollectionGroupPriceQueryResponse;
use App\Setting\Bus\Query\CollectionGroupPrice\GetAllCollectionGroupPriceQuery;
...
#[Route('/api/collection-groups-prices', name: 'collection_group_prices_get_all', methods: ['GET'])]
class CollectionGroupPriceController extends CommandQueryController
{
    ...
    #[OA\Response(
        ...
        content: new Model(type: CollectionGroupPriceQueryResponse::class)
    )]
    #[OA\Tag(name: 'Setting')]
    public function __invoke(Request $request): JsonResponse
    {
        ...
        $query = new GetAllCollectionGroupPriceQuery($page, $itemsPerPage);
        $response = $this->ask($query);

        return SuccessResponse::create(
            'collection_groups_price_retrieval',
            $response->toArray()
        );
    }
}
