...
use App\Setting\Repository\ManufacturerRepository as MRepo;

class CreateSupplierInvoiceCommandHandler implements CommandHandler
{
    ...
    public function __invoke(CreateSupplierInvoiceCommand $command): SupplierInvoiceResponse
    {
        $invoice = new SupplierInvoice();
        $invoiceNumber = $command->invoiceNumber ?? $this->repository->getNextInvoiceNumber();
        ...
        $prices = new SupplierInvoicePrices();
