...
use App\Contremarque\Bus\Command\CarpetSpecification\CreateOrUpdateCarpetSpecificationCommand;
...
class CarpetSpecificationController extends CommandQueryController
{
    #[Route(
        path: '/api/carpetDesignOrder/{carpetDesignOrderId}/createCarpetSpecification',
        name: 'carpetSpecification_creation',
        methods: ['POST']
    )]
    #[OA\Post(
        path: '/api/carpetDesignOrder/{carpetDesignOrderId}/createCarpetSpecification',
    ...
    public function __invoke(
        ...
        $command = new CreateOrUpdateCarpetSpecificationCommand($carpetDesignOrderId, $carpetSpecificationDTO);
        $response = $this->handle($command);

        return SuccessResponse::create('carpet_specification_created_or_updated', $response->toArray());
    }
}
