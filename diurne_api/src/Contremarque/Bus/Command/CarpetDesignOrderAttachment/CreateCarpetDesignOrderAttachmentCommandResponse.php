...
class CreateCarpetDesignOrderAttachmentCommandResponse implements CommandResponse
{
    public function __construct(private readonly ?CarpetDesignOrderAttachment $carpetDesignOrderAttachment, private readonly ?array $errors = [])
    {
    }
