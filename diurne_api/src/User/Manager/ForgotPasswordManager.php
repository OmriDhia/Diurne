...
#[AsDecorator(decorates: CoopTilleuls\ForgotPasswordBundle\Manager\ForgotPasswordManager::class)]
class ForgotPasswordManager extends \CoopTilleuls\ForgotPasswordBundle\Manager\ForgotPasswordManager
{
    public function __construct(
        private readonly PasswordTokenManager $passwordTokenManager,
        private readonly EventDispatcherInterface $dispatcher,
        private readonly ProviderChainInterface $providerChain
    ) {
        parent::__construct($this->passwordTokenManager, $this->dispatcher, $this->providerChain);
    }
