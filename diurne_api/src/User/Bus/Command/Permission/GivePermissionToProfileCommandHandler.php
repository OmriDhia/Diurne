...
class GivePermissionToProfileCommandHandler implements CommandHandler
{
    ...
    public function __invoke(GivePermissionToProfileCommand $command): ProfilePermissions
    {
        ...
        return new ProfilePermissions($profile->getName(), $profile->getPermission()->map(fn($obj) => ['permission_id' => $obj->getId(), 'name' => $obj->getName()])->getValues());
    }
}
