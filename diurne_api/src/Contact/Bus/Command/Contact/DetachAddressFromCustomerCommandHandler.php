...
class DetachAddressFromCustomerCommandHandler implements CommandHandler
{
    ...
    public function __invoke(DetachAddressFromCustomerCommand $command): DetachAddressFromCustomerResponse
    {
        ...
        return new DetachAddressFromCustomerResponse($customer, $address);
    }
}
